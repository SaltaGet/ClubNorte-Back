...
func CreateTestData() error {
	...
	IncomeSportsCourts := []models.IncomeSportsCourts{
		{ID: 1, PartialRegisterID: register1.ID, RestRegisterID: &register1.ID, UserID: users[2].ID, PointSaleID: point1.ID, Shift: "tarde", SportsCourtID: 1, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "efectivo", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},
		{ID: 2, PartialRegisterID: register1.ID, RestRegisterID: &register1.ID, UserID: users[2].ID, PointSaleID: point1.ID, Shift: "tarde", SportsCourtID: 1, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "transferencia", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},
		{ID: 3, PartialRegisterID: register1.ID, RestRegisterID: &register1.ID, UserID: users[2].ID, PointSaleID: point1.ID, Shift: "tarde", SportsCourtID: 1, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "efectivo", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},

		{ID: 4, PartialRegisterID: register2.ID, RestRegisterID: &register2.ID, UserID: users[2].ID, PointSaleID: point2.ID, Shift: "tarde", SportsCourtID: 2, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "tarjeta", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},
		{ID: 5, PartialRegisterID: register2.ID, RestRegisterID: &register2.ID, UserID: users[2].ID, PointSaleID: point2.ID, Shift: "tarde", SportsCourtID: 2, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "efectivo", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},
		{ID: 6, PartialRegisterID: register2.ID, RestRegisterID: &register2.ID, UserID: users[2].ID, PointSaleID: point2.ID, Shift: "tarde", SportsCourtID: 2, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "tarjeta", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},

		{ID: 7, PartialRegisterID: register3.ID, RestRegisterID: &register3.ID, UserID: users[2].ID, PointSaleID: point3.ID, Shift: "tarde", SportsCourtID: 4, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "transferencia", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},
		{ID: 8, PartialRegisterID: register3.ID, RestRegisterID: &register3.ID, UserID: users[2].ID, PointSaleID: point3.ID, Shift: "tarde", SportsCourtID: 3, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "efectivo", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},
		{ID: 9, PartialRegisterID: register3.ID, RestRegisterID: &register3.ID, UserID: users[2].ID, PointSaleID: point3.ID, Shift: "tarde", SportsCourtID: 4, DatePlay: now, PartialPay: 1000, RestPay: &restPay, Total: 3000, PartialPaymentMethod: "tarjeta", RestPaymentMethod: &restMethodPay, DatePartialPay: now, DateRestPay: &now},
	}
