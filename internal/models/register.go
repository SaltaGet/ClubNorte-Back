...
type Register struct {
	...
	UserOpen    User      `gorm:"foreignKey:UserID;references:ID" json:"user_open"`
	OpenAmount  float64   `gorm:"" json:"open_amount"`
	HourOpen    time.Time `gorm:"" json:"hour_open"`

	UserCloseID *uint      `gorm:"not null" json:"user_close_id"`
	UserClose   *User      `gorm:"foreignKey:UserID;references:ID" json:"user_close"`
